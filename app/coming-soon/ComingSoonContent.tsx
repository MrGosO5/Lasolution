      ...
      <main>
        ...
        <section ref={formRef} id="waitlist" className="relative bg-[#FAFAFA] py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <Reveal className="mx-auto mt-3 max-w-xl text-center" delay={0.06}>
              <p className="text-gray-600">{C.form.subtitle}</p>
            </Reveal>

            {/* Figma Frame 74 : bloc rose + filigranes ; carte blanche 619px (Component 1) */}
            <Reveal delay={0.12} y={32}>
            <ComingSoonFormFrame74>
                    ...
                    <form onSubmit={onWaitlistSubmit} className="flex flex-col gap-5">
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2 text-left">
                          ...
                          {/* overflow-visible : la liste du PhoneDialSelect s’affiche sous le champ (overflow-hidden la masquait) */}
                          <div
